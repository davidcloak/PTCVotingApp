...
namespace PTCVotingWebApp.Controllers
{
    public class AspNetUserRolesController : Controller
    {
        ...
        public AspNetUserRolesController(voteShieldContext context)
        {
            _context = context;
        }
        ...
        {
            var voteShieldContext = _context.AspNetUserRoles.Include(a => a.Role).Include(a => a.User);
            return View(await voteShieldContext.ToListAsync());
        }
